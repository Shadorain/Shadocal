...
pub fn EventList() -> Element {
    rsx! {
        section { class: "antialiased max-w-screen-xl px-4 py-8 mx-auto lg:px-6 sm:py-16 lg:py-24",
                ...
                div { class: "-my-4 divide-y divide-gray-200 dark:divide-gray-700",
                    div { class: "flex flex-col gap-2 py-4 sm:gap-6 sm:flex-row sm:items-center",
                        ...
                        h3 { class: "text-lg font-semibold text-gray-900 dark:text-white",
                            a { href: "#", class: "hover:underline", "Opening remarks" }
                        }
                    }
                    div { class: "flex flex-col gap-2 py-4 sm:gap-6 sm:flex-row sm:items-center",
                        p { class: "w-32 text-lg font-normal text-gray-500 sm:text-right dark:text-gray-400 shrink-0",
                    ...
                    div { class: "flex flex-col gap-2 py-4 sm:gap-6 sm:flex-row sm:items-center",
                        ...
                        h3 { class: "text-lg font-semibold text-gray-900 dark:text-white",
                            a { href: "#", class: "hover:underline", "Coffee Break" }
                        }
                    }
                    div { class: "flex flex-col gap-2 py-4 sm:gap-6 sm:flex-row sm:items-center",
                        p { class: "w-32 text-lg font-normal text-gray-500 sm:text-right dark:text-gray-400 shrink-0",
                    ...
                    div { class: "flex flex-col gap-2 py-4 sm:gap-6 sm:flex-row sm:items-center",
                        ...
                        h3 { class: "text-lg font-semibold text-gray-900 dark:text-white",
                            a { href: "#", class: "hover:underline", "Drinks & networking" }
                        }
                    }
                }
            }
